...
set-mailboxautoreplyconfiguration -identity "User Name" -AutoReplyState scheduled -starttime "6/7/2021 12:00am" -endtime "6/11/2021 11:59pm" -internalmessage "i will be on PTO June 7th through June 11th" -externalmessage "I will be on PTO June 7th through June 11th".
